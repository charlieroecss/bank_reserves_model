...
class Person(RandomWalker):
    def __init__(self, unique_id, pos, model, moore, bank, rich_threshold):
        ...
        #savings - loans, see balance_books() below
        self.wealth = 0
    ...
    def do_business(self):
        ...
        if self.savings > 0 or self.wallet > 0 or self.bank.bank_to_loan > 0:
            ...
            if len(my_cell) > 1:
                #set customer to self for while loop 
                customer = self
                while customer == self:
    ...
    def deposit_to_savings(self, amount): #part of balance_books()
    ...
    def withdraw_from_savings(self, amount): #part of balance_books()
    ...
    def repay_a_loan(self, amount): #part of balance_books()
    ...
    def take_out_loan(self, amount): #part of balance_books()
